...
import { PrinterStatus, TemperatureResponse, FirmwareVersionResponse, PrinterDebugMonitor, PrintingPercentageResponse, } from '../../printerSdk/entities';
...
export class PrinterService implements IPrinterService {
    ...
    GetPrintingPercentAsync(): Promise<PrintingPercentageResponse> {
        ...
        return this.printer.GetPrintPercentageAsync();
    }
}
